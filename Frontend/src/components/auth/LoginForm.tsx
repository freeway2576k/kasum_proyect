...
export function LoginForm({
  ...
  const onSubmit = (data: LoginFormData) => {
    console.log(data);
    // aqui hacer llamada a la api
    // aqui guardar la respuesta en un authStorage con zustand
  }
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        <Field>
          ...
          <Input id="password" type="password" required {...field} aria-invalid={fieldState.invalid} autoComplete="off" />
