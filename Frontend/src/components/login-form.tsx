  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldDescription className="text-center">
                    <p>{t("auth.login.dont_have_account")} <a href="#">t</a></p>
                </FieldDescription>
              </Field>
              
              <FieldSeparator className="*:data-[slot=field-separator-content]:bg-card">
                <p>{t("auth.login_form.continue_with")}</p>
              </FieldSeparator>
              <Field>
                <Button variant="outline" type="button">
                  ...
                  {t("auth.login_form.login_with_apple")}
                </Button>
                <Button variant="outline" type="button">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                  ...
                  {t("auth.login_form.login_with_google")}
                </Button>
              </Field>
            </FieldGroup>
          </form>
      ...
      <FieldDescription className="px-6 text-center">
        ...
        components={{
          termsLink: <Link to="#"></Link>,
          privacyLink: <Link to="#"></Link>
        }}>
        </Trans>
      </FieldDescription>
    </div>
